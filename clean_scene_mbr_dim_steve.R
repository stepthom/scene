...
scene_mbr_dim<-
      mutate(scene_mbr_dim, psnl_city = ifelse(psnl_post_cd %in% Max_city$psnl_post_cd, psnl_city_2, psnl_city))
...
scene_mbr_dim<-
  mutate(scene_mbr_dim, psnl_city=ifelse(psnl_city=='tor','toronto',psnl_city)) 
